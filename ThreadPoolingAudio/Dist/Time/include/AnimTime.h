...
namespace Azul
{
	...
	public:
		...
		*/
		TIME_LIBRARY_API friend const AnimTime operator*(const float, const AnimTime &);
		...
		*/
		TIME_LIBRARY_API friend const AnimTime operator*(const int, const AnimTime &);
		...
		TIME_LIBRARY_API inline AnimTime();
		...
		*/
		TIME_LIBRARY_API explicit AnimTime(const Duration);

		// Creates a copy of the specified AnimTime. 
		TIME_LIBRARY_API inline AnimTime(const AnimTime &);
		...
		*/
		TIME_LIBRARY_API inline AnimTime &operator=(const AnimTime &rhs);

		// destrutor
		TIME_LIBRARY_API ~AnimTime()
		{ }
		...
		*/
		TIME_LIBRARY_API bool operator==(const AnimTime &rhs) const;
		...
		*    }
		*/
		TIME_LIBRARY_API const AnimTime operator-() const;
		...
		*    }
		*/
		TIME_LIBRARY_API const AnimTime operator+(const AnimTime &rhs) const;
		...
		*    }
		*/
		TIME_LIBRARY_API AnimTime &operator+=(const AnimTime &rhs);
		...
		*/
		TIME_LIBRARY_API const AnimTime operator*(const float) const;
		...
		*/
		TIME_LIBRARY_API const AnimTime operator*(const int) const;
		...
		*    }
		*/
		TIME_LIBRARY_API AnimTime &operator*=(const float);
		...
		*    }
		*/
		TIME_LIBRARY_API AnimTime &operator*=(const int);
		...
		*/
		TIME_LIBRARY_API float operator/(const AnimTime &denominator) const;
		...
		*/
		TIME_LIBRARY_API const AnimTime operator/(const float denominator) const;
		...
		* note: Dividing by zero is undefined.
		*/
		TIME_LIBRARY_API const AnimTime operator/(const int denominator) const;
		...
		* note: Dividing by AnimTime(ZERO) is undefined.
		*/
		TIME_LIBRARY_API static int 	Quotient(const AnimTime &numerator, const AnimTime &denominator);
		...
		* note: Dividing by AnimTime(ZERO) is undefined.
		*/
		TIME_LIBRARY_API static const AnimTime 	Remainder(const AnimTime &numerator, const AnimTime &denominator);
	...
	//---------------------------------------------------------------------------
	TIME_LIBRARY_API AnimTime::AnimTime() : privRawAnimTime(0)
	{
	}


	TIME_LIBRARY_API AnimTime::AnimTime(const AnimTime &rhs) : privRawAnimTime(rhs.privRawAnimTime)
	{
	}


	TIME_LIBRARY_API AnimTime &AnimTime::operator=(const AnimTime &rhs)
	{
		if (this != &rhs)
		{
